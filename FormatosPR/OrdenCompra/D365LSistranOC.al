report 60105 "D365LSistranOC"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultRenderingLayout = COL_SISTRAN;
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            RequestFilterHeading = 'Orden de Compra';
            ...
            column(Order_Date; Format("Order Date", 0, 4))
            {

            }
            column(Expected_Receipt_Date; Format("Expected Receipt Date", 0, 4))
            {

            }
            column(Posting_Description; "Posting Description") { }
            column(Payment_Terms_Code; "Payment Terms Code") { }
            column(LyL_Pedido; LyL_Pedido) { }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        //  column(LyLDescription; PurchLine.LyLDescription) { }
            ...
            var
            begin
                TotalAmount := GetTotalAmount("Purchase Header"."No.");
            end;
    ...
    rendering
    {
        ...
        {
            Type = Word;
            LayoutFile = 'Reports/D365_COL_OrdenCompra.docx';
        }
        layout(MX_SISTRAN)
        {
            Type = Word;
            LayoutFile = 'Reports/D365_MX_OrdenCompra.docx';
        }
        layout(EC_SISTRAN)
        {
            Type = Word;
            LayoutFile = 'Reports/D365_EC_OrdenCompra.docx';
        }
        layout(PR_SISTRAN)
        {
            Type = Word;
            LayoutFile = 'Reports/D365_PR_OrdenCompra.docx';
        }
    }
    ...
    var
        ...
        CompanyInfoPhoneNoCaptionLbl: Label 'Teléfono';
        CompanyInfoVATRegNoCaptionLbl: Label 'NIT';
    ...
    local procedure GetTotalAmount(NoDocument: Code[20]): Decimal
    var
        PurchaseLine: Record "Purchase Line";
    begin
        PurchaseLine.SetFilter("Document No.", NoDocument);
    ...
    local procedure GetOrder(PH_no: Code[20]): Text
    var
        ReservationEntry: Record "Reservation Entry";
        cu: Codeunit "Reservation Engine Mgt.";
    begin
        ReservationEntry.SetFilter("Source ID", PH_no);
        if ReservationEntry.FindFirst() then begin
            exit(cu.CreateFromText(ReservationEntry));
        end;
    end;
}