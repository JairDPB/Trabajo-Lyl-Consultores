table 50112 "D365L Purchase Trace Buffer"
{
    ...
    fields
    {
        ...
        field(6; "Buyer Code"; Code[50]) { }
        field(7; Status; Code[50]) { }
        ...
        field(11; "Order Item No."; Code[50]) { }
        field(12; "Order Description"; Text[100]) { }

        field(13; "Currency Code"; Code[50]) { }
        field(14; TRM; Decimal) { }

        field(15; "Order Quantity"; Decimal) { }
        field(16; "Unit of Measure"; Code[50]) { }
        field(17; "Order Unit Cost"; Decimal) { }
        field(18; "Order Line Amount"; Decimal) { }

        // ==== DIMENSIONES ====
        field(30; "Dim 1"; Code[30]) { }
        field(31; "Dim 2"; Code[30]) { }
        field(32; "Dim 3"; Code[30]) { }
        field(33; "Dim 4"; Code[30]) { }
        field(34; "Dim 5"; Code[30]) { }
        field(35; "Dim 6"; Code[30]) { }
        field(36; "Dim 7"; Code[30]) { }
        field(37; "Dim 8"; Code[30]) { }

        // ==== RECEPCIÓN ====
        field(50; "Receipt No."; Code[50]) { }
        field(51; "Receipt Date"; Date) { }
        field(52; "Received Quantity"; Decimal) { }

        // ==== FACTURA ====
        field(60; "Invoice No."; Code[50]) { }
        field(61; "Vendor Invoice No."; Code[50]) { }
        field(62; "Invoice Date"; Date) { }

        field(63; "Invoice Item No."; Code[50]) { }
